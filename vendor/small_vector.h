...
template<typename T>
inline constexpr auto isPod = std::is_standard_layout_v<T> &&std::is_trivial_v<T>;
template<typename T>
class SmallVectorImpl : public SmallVectorTemplateBase<T, isPod<T>> {
  typedef SmallVectorTemplateBase<T, isPod<T>> SuperClass;
...
protected:
  ...
  explicit SmallVectorImpl(unsigned N)
      : SmallVectorTemplateBase<T, isPod<T>>(N * sizeof(T)) {
  }
